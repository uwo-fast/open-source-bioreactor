...
gearbox_36gp_5p18       = ["36GP-5.18",     [36,  26  ], [8,           20         ], [22,         3         ], 27.6,            4.2    ];
...
// The input bore is not dimensioned on the drawing, hence undef.
gearbox_36pg_3429_5p2   = ["36PG-3429-5.2", [36,  26.5], [8,           20         ], undef,                    28,              3      ];
