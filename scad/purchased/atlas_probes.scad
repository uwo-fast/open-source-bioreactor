...
// g2 is the current product and the sheet above; g1 are no longer sold to my knowledge as of
// 2026-08. Both carry ENV-40-PH: the SKU names the line, not the generation.
...
// g2 is the current product and the sheet above; g1 are no longer sold to my knowledge as of
// 2026-08. Both carry ENV-40-DOX, as the pH pair.
