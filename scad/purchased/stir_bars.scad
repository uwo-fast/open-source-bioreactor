...
// PTFE-coated alnico bars, the plain cylindrical kind. The bar sits centred on the vessel's punt
// plateau and follows the magnets on the fan hub under the base. No part number yet: any bar of
// the size does, and none has been bought, so the purchase list does not enrol these rows.
