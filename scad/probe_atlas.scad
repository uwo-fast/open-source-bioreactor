...
module atlas_probe(neck_d = 8, neck_h = 20, neck_taper_d = 6, body_d = 16, body_h = 40, tip_d = 12, tip_h = 15, wire_d = 4,
             wire_h = 25, colors = [ "Black", "Red", "Black", "Yellow" ], position_base = false)
{
