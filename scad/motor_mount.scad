 ...
 */
module motor_mount(height, width, wall_thickness, floor_thickness, inner_dia, pillar_width, base_screws_diameter,
                   base_screws_cdist, face_screws_diameter, face_screws_cdist)
{
