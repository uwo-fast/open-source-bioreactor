...
module tube_mount(
  ...
  difference() {
    ...
    translate([0, 0, height / 2]) {
      cylinder(
        d2=hole_diameter + tube_allowance, d1=hole_diameter + tube_allowance - hole_taper,
...
tube_mount(
  example_width, example_height, example_hole_diameter, example_hole_hole_taper, example_tube_allowance,
